...
Objective: Preprocess forcing, OpenLandMap soil, and GSSM reference SSM inputs into aligned NetCDF files for SWB runs.
Author: Yi Yu
Created: 2026-04-19
...
def process_soil_properties_from_openlandmap(
    ...
    clay_da = _reproject_to_template(soil_predictors["clay"], grid, resampling = Resampling.bilinear)
    sand_da = _reproject_to_template(soil_predictors["sand"], grid, resampling = Resampling.bilinear)
    soc_da = _reproject_to_template(soil_predictors["soc"], grid, resampling = Resampling.bilinear)
